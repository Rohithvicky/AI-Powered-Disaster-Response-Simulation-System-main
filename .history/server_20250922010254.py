...
class DisasterSimulator:
    ...
    def _update_victim_survival(self):
        ...
        for victim in self.state.victims:
            ...
            # Mark victims as dead if survival probability is too low
            if victim.survival_probability <= 0.05:
    ...
    def _ai_move(self):
        ...
        if not best_victim or not best_path:
            print("No safe path found, trying emergency escape")
    ...
    def _select_resources_for_rescue(self, available_resources):
        ...
        if not available_resources:
            return ["emergency_kit"]  # Default resource
    ...
    def _add_used_resources_at_victim_location(self, position, used_resources):
        ...
        # This could be used to show resource usage on the grid
