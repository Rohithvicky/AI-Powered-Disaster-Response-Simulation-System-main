...
class SimulationDashboard {
    ...
    updateMetrics() {
        ...
        // Add disaster-specific information
        this.updateDisasterInfo(disasterType);
    }

    updateDisasterInfo(disasterType) {
        const disasterInfo = {
            'earthquake': '🌍 Ground shaking, building collapse',
            'fire': '🔥 Rapid spread, smoke and heat',
            'flood': '🌊 Water rising, flooding areas',
            'tornado': '🌪️ Spiral winds, debris flying',
            'hurricane': '🌀 Strong winds, heavy rain'
        };
        
        // Update any disaster-specific UI elements if needed
        console.log(`Current disaster: ${disasterType} - ${disasterInfo[disasterType] || 'Unknown disaster type'}`);
    }
