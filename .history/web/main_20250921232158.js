...
class SimulationDashboard {
    ...
    drawGrid() {
        ...
        if (this.simulationState.victims) {
            this.simulationState.victims.forEach(victim => {
                ...
                // Draw SVG victim icon
                this.drawSVGIcon(ctx, 'victim-icon', x + cellSize/2 - 12, y + cellSize/2 - 12, 24, 24);
            });
        }
    ...
    drawSVGIcon(ctx, iconId, x, y, width, height) {
