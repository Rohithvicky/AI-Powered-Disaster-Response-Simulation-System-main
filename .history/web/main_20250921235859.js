...
class SimulationDashboard {
    ...
    drawGrid() {
        ...
        // Draw hazards with proper red colors for fire
        if (this.simulationState.hazards) {
            this.simulationState.hazards.forEach(hazard => {
                ...
                if (intensity > 0.2) {
                    ...
                    // Use proper red colors for fire hazards
                    let baseColor;
                    if (intensity > 0.8) {
                        baseColor = '#dc2626'; // Bright red for high intensity
                    } else if (intensity > 0.5) {
                        baseColor = '#ef4444'; // Medium red
                    } else {
