...
class SimulationDashboard {
    ...
    drawGrid() {
        ...
        // Draw terrain with clear, consistent colors
        if (this.simulationState.grid) {
            for (let i = 0; i < gridSize; i++) {
                for (let j = 0; j < gridSize; j++) {
                    ...
                    if (terrain === 'G') color = '#065f46'; // Dark green for grass
                    else if (terrain === 'W') color = '#0c4a6e'; // Dark blue for water
                    else if (terrain === 'R') color = '#7c2d12'; // Dark red for rock
                    else if (terrain === 'U') color = '#374151'; // Dark gray for urban
                    
                    ctx.fillStyle = color;
                    ctx.fillRect(x + 1, y + 1, cellSize - 2, cellSize - 2);
                    
                    // Add subtle border for grid clarity
