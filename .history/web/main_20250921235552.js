...
class SimulationDashboard {
    ...
    drawGrid() {
        ...
        // Draw resources with professional styling
        if (this.simulationState.resources) {
            this.simulationState.resources.forEach(resource => {
                ...
                // Draw professional background for resources
                if (resourceType.startsWith('used_')) {
                    ctx.fillStyle = '#6b7280'; // Gray for used resources
                } else {
                    ctx.fillStyle = '#10b981'; // Green for available resources
                }
                ctx.fillRect(x + 2, y + 2, cellSize - 4, cellSize - 4);
                ...
                ctx.strokeStyle = resourceType.startsWith('used_') ? '#4b5563' : '#059669';
                ctx.lineWidth = 1;
                ctx.strokeRect(x + 1, y + 1, cellSize - 2, cellSize - 2);
            });
        }
