...
class SimulationDashboard {
    ...
    drawGrid() {
        ...
        // Draw hazards with clear, consistent visualization
        if (this.simulationState.hazards) {
            this.simulationState.hazards.forEach(hazard => {
                ...
                if (intensity > 0.2) {
                    ...
                    // Use consistent colors and clear boundaries
                    let hazardColor;
                    if (intensity > 0.8) {
                        hazardColor = `rgba(220, 38, 38, 0.9)`; // High intensity - dark red
                    } else if (intensity > 0.5) {
                        hazardColor = `rgba(239, 68, 68, 0.8)`; // Medium intensity - red
                    } else {
                        hazardColor = `rgba(248, 113, 113, 0.6)`; // Low intensity - light red
                    }
