...
class SimulationDashboard {
    ...
    drawGrid() {
        ...
        // Draw grid lines with bright, clear visibility
        ...
        // Add bright border lines every 5 cells for better orientation
        ...
        // Draw terrain with bright, vibrant colors
        if (this.simulationState.grid) {
            for (let i = 0; i < gridSize; i++) {
                for (let j = 0; j < gridSize; j++) {
                    ...
                    let color = '#1e293b'; // Brighter default dark
                    if (terrain === 'G') color = '#16a34a'; // Bright green for grass
                    else if (terrain === 'W') color = '#0284c7'; // Bright blue for water
                    else if (terrain === 'R') color = '#dc2626'; // Bright red for rock
                    else if (terrain === 'U') color = '#6b7280'; // Brighter gray for urban
                    
                    ctx.fillStyle = color;
                    ctx.fillRect(x + 1, y + 1, cellSize - 2, cellSize - 2);
                    
                    // Add bright border for grid clarity
        ...
        // Draw hazards with bright, vibrant colors
        if (this.simulationState.hazards) {
            this.simulationState.hazards.forEach(hazard => {
                ...
                if (intensity > 0.2) {
                    ...
                    // Use bright, vibrant colors with clear boundaries
                    let hazardColor;
                    if (intensity > 0.8) {
                        hazardColor = `rgba(255, 59, 48, 0.95)`; // High intensity - bright red
                    } else if (intensity > 0.5) {
                        hazardColor = `rgba(255, 99, 71, 0.9)`; // Medium intensity - bright orange-red
                    } else {
                        hazardColor = `rgba(255, 140, 0, 0.8)`; // Low intensity - bright orange
                    }
                    
                    ctx.fillStyle = hazardColor;
                    ctx.fillRect(x + 1, y + 1, cellSize - 2, cellSize - 2);
                    
                    // Add bright border for clarity
        ...
        // Draw recommended path with bright colors
        ...
        // Draw rescue team with emoji icon
        if (this.simulationState.rescue_team) {
            ...
            // Add bright energy indicator
            const energyPercent = (this.simulationState.rescue_team.efficiency || 100) / 100;
            ctx.fillStyle = energyPercent > 0.5 ? '#22c55e' : energyPercent > 0.2 ? '#fbbf24' : '#ef4444';
            ctx.fillRect(x + 2, y + cellSize - 4, (cellSize - 4) * energyPercent, 3);
            
            // Add bright border around rescue team
